...
# export CONTROLNET_DIR="lllyasviel/control_v11p_sd15_softedge"  # Eval ControlNet
export CONTROLNET_DIR="checkpoints/hed/controlnet"  # Eval our ControlNet++
...
accelerate launch --main_process_port=22456 --num_processes=8 eval/eval.py --task_name='hed' --dataset_name='limingcv/MultiGen-20M_canny_eval' --dataset_split='validation' --condition_column='image' --prompt_column='text' --model_path $CONTROLNET_DIR --guidance_scale=${SCALE} --num_inference_steps=${NUM_STEPS}
